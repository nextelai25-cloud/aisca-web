...
import { ShoppingBag, ArrowLeft, CheckCircle, CreditCard, ChevronRight } from 'lucide-react'
...
export default function TshirtPage() {
  ...
  const images = [
    '/products/AISCA T SHIRT.webp',
    // 2 Placeholder slots with gradients and crest indicators
  ...
  const handleSubmitOrder = async (e: React.FormEvent) => {
    ...
    try {
      const res = await fetch('/api/orders', {
        ...
        body: JSON.stringify({
          product_id: 'aisca-tshirt-black',
          product_name: 'AISCA Official T-Shirt Black Edition',
          size: selectedSize,
          quantity: quantity,
    ...
    <div style={{ background: '#080808', minHeight: '100vh', display: 'flex', flexDirection: 'column' }}>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "itemListElement": [
          ...
          {"@type":"ListItem","position":2,"name":"Products","item":"https://aisca.lk/products/tshirt"}
        ]
      })}} />
            ...
            {!orderSuccess ? (
              ...
              >
                ...
                <div className="lg:col-span-6 space-y-8" style={{ maxWidth: '500px', width: '100%' }}>
                  <div>
                    <span className="text-[10px] tracking-[0.2em] font-bold text-white/50 uppercase">Premium Apparel</span>
                    <h1 style={{
                      ...
                      AISCA Official T-Shirt Black Edition
                    </h1>
                  ...
                  <p style={{
                    ...
                    Premium heavyweight cotton blend tee featuring the embroidered AISCA crest. Worn by commerce society leaders across all 25 educational districts.
                  </p>
