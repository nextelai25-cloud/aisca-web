...
export default function BlazerPinPage() {
  ...
  const handleSubmitOrder = async (e: React.FormEvent) => {
    ...
    try {
      const res = await fetch('/api/orders', {
        ...
        body: JSON.stringify({
          product_id: 'aisca-blazerpin',
          product_name: 'AISCA Gold Blazer Pin',
          size: null,
          quantity: quantity,
            ...
            {!orderSuccess ? (
              ...
              >
                ...
                <div className="lg:col-span-6 space-y-8" style={{ maxWidth: '500px', width: '100%' }}>
                  <div>
                    <span className="text-[10px] tracking-[0.2em] font-bold text-white/50 uppercase">Official Accessories</span>
                    <h1 style={{
                  ...
                  <p style={{
                    ...
                    Die-cast metallic shield pin. A polished mark of community leadership for formal school academic assemblies.
                  </p>
