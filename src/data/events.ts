...
export const events: Event[] = [
  {
    ...
    year: '2026',
    date: 'August 01, 2026',
    coverPhoto: '/events/bs360-finals/cover.webp',
    photos: [
      '/events/bs360-finals/cover.webp'
    ],
    description: `The island's brightest commerce minds, one final stage.. On August 01, 2026, BS360 reached its grand finale at Mahanama College, Colombo, a high-energy, on-ground showdown that brought together the 32 top teams who had battled their way through the virtual qualifying round. The occasion was graced by chief guest Mr. Janik Jayasuriya, Founder and Managing Director of Celeste, and delivered a spectacle of knowledge, speed, and school spirit.\n\nThe competition unfolded across multiple classrooms running simultaneously, with teams facing a live, interactive quiz grid spanning Economics, Business Studies, Accounting, and General Knowledge. Every question was presented in English, Sinhala, and Tamil, keeping the finals as inclusive as they were challenging, while the difficulty climbed from Easy all the way to Super Hard.\n\nAs the points mounted and the matches intensified, the Musaeus College Commerce Society rose above the rest to be crowned BS360 champions, while Bandaranayake College, Gampaha earned the title of Most Popular Quiz Team. The finals capped off a landmark competition for AISCA, a proud celebration of academic excellence, healthy rivalry, and the islandwide commerce community coming together.`
  },
  {
    id: '11',
    ...
    year: '2026',
    date: 'July 13, 2026',
    coverPhoto: '/events/forum2/cover.webp',
    photos: [
      '/events/forum2/cover.webp',
      '/events/forum2/photo1.webp',
      '/events/forum2/photo2.webp',
      '/events/forum2/photo3.webp'
    ],
